...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ overflowX:'hidden' }}>
          ...
          <div className="mob-drawer">
            ...
            <div style={{ flex:1,overflowY:'auto',paddingBottom:20 }}>
              ...
              <div style={{ margin:'0 16px 16px',padding:14,background:'#f8fafc',borderRadius:8,border:'1px solid #e2e8f0' }}>
                ...
                <a href="tel:+917411642999" style={{ display:'flex',alignItems:'center',gap:8,padding:'8px 0',textDecoration:'none',fontFamily:'DM Sans,sans-serif',fontSize:'0.84rem',fontWeight:600,color:'#0f172a',borderBottom:'1px solid #e2e8f0' }}>📞 +91 74116 42999</a>
                <a href="https://wa.me/917411642999" target="_blank" rel="noopener noreferrer" style={{ display:'flex',alignItems:'center',gap:8,padding:'8px 0',textDecoration:'none',fontFamily:'DM Sans,sans-serif',fontSize:'0.84rem',fontWeight:600,color:'#22c55e' }}>💬 WhatsApp Us</a>
              </div>
            </div>
          </div>
        </>
          ...
          <div className="footer-grid">
            ...
            <div>
              ...
              <div style={{ marginTop:18,display:'flex',gap:10,flexWrap:'wrap' }}>
                {[{l:'YT',c:'#ef4444',h:'https://youtube.com/@manikyaservices'},{l:'IN',c:'#3b82f6',h:'https://linkedin.com/company/manikyaservices'},{l:'IG',c:'#a855f7',h:'https://instagram.com/manikyaservices'},{l:'WA',c:'#22c55e',h:'https://wa.me/917411642999'}].map(s=>(
      ...
      {/* WhatsApp FAB */}
      <a href="https://wa.me/917411642999?text=Hello%20Manikya%20Money%20Service%2C%20I%20would%20like%20to%20know%20more%20about%20your%20services."
        target="_blank" rel="noopener noreferrer" className="wa-fab"
        style={{ position:'fixed',bottom:24,right:24,zIndex:1000,width:52,height:52,borderRadius:'50%',background:'#22c55e',boxShadow:'0 4px 20px rgba(34,197,94,0.5)',display:'flex',alignItems:'center',justifyContent:'center',textDecoration:'none',animation:'waPulse 2s infinite' }}>
