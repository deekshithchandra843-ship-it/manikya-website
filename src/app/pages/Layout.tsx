  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ overflowX: 'hidden' }}>
      <style>{`
        ...
        .mobile-admin-btn:hover { background: #f59e0b; color: #000; }
        ...
        /* ── NAV INNER — desktop flex, hides links < md ── */
        .nav-inner {
          max-width: 1320px;
          margin: 0 auto;
      ...
      <header className={`nav-root ${scrolled ? 'scrolled' : ''}`}>
        <div className="nav-glass">
          <div className="nav-inner">
            ...
            {/* Brand */}
            <Link to="/" style={{ display:'flex', alignItems:'center', gap:'clamp(7px,1.5vw,12px)', textDecoration:'none', flexShrink:0 }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:8, flexShrink:0 }}>
              <Link to="/admin" className="admin-btn admin-btn-desktop" style={{ display:'flex' }}>
          ...
          <div className="mobile-nav">
            <div className="mobile-nav-header">
              <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                ...
                <div style={{ fontFamily:'DM Sans,sans-serif', fontWeight:700, fontSize:'0.8rem', color:'#0f172a', lineHeight:1.3 }}>
                  Manikya Money<br/>
                  <span style={{ color:'#f59e0b', fontSize:'0.62rem', fontWeight:600 }}>GROWING TOGETHER</span>
                </div>
              </div>
            ...
            <div style={{ flex:1, overflowY:'auto', paddingBottom:20 }}>
              {navLinks.map(link => (
                <Link key={link.path} to={link.path} className={`mobile-link ${isActive(link.path) ? 'active' : ''}`} onClick={() => setMobileMenuOpen(false)}>
                  {link.label}
                </Link>
              ))}
              ...
              <div style={{ margin:'0 18px', padding:'14px', background:'#f8fafc', borderRadius:8, border:'1px solid #e2e8f0' }}>
                <div style={{ fontFamily:'DM Sans,sans-serif', fontSize:'0.62rem', fontWeight:700, color:'#94a3b8', textTransform:'uppercase', letterSpacing:'0.15em', marginBottom:10 }}>Quick Contact</div>
          ...
          <div className="footer-grid">
            ...
            <div>
              ...
              <div style={{ display:'flex', gap:8, marginTop:16, flexWrap:'wrap' }}>
                {['Media','Finance','Trading','Realty'].map(tag=>(
                  <span key={tag} style={{ fontSize:'0.62rem', fontFamily:'DM Sans,sans-serif', fontWeight:700, letterSpacing:'0.1em', textTransform:'uppercase', padding:'3px 10px', borderRadius:20, background:'rgba(255,255,255,0.07)', border:'1px solid rgba(255,255,255,0.12)', color:'#94a3b8' }}>{tag}</span>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              {[
                ...
                <a key={i} href={c.href} target={i >= 2 ? '_blank' : undefined} rel="noopener noreferrer" className="footer-contact-item" style={{ textDecoration:'none' }}>
      ...
      <a
        ...
        style={{
          position:'fixed', bottom:'clamp(16px,3vw,24px)', right:'clamp(16px,3vw,24px)', zIndex:1000,
